...
public class ChameleonGUIActivity
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btnChameleon_Information_Dowmload) {
            getInfo();
        } else if (id == R.id.btnChameleon_UID_Set) {
            setUid();
        } else if (id == R.id.btnChameleon_Datas_Dowmload) {
            download();
        } else if (id == R.id.btnChameleon_Datas_Upload) {
            upload();
        } else if (id == R.id.btnChameleon_Datas_Reset) {
            reset();
        } else if (id == R.id.btnChameleon_Sniff_Decrypt) {
            decrypt(true);
        } else if (id == R.id.btnChameleon_Sniff_Decrypt_One) {
            decrypt(false);
        } else if (id == R.id.btnChameleon_Command_Send) {
            sendAT();
        } else if (id == R.id.btnChameleon_Command_Show) {
            fpDialog.show();
        } else if (id == R.id.btnChameleon_Version_Show) {
            showVer();
        } else if (id == R.id.btnChameleon_Device_Reset) {
        ...
        } else if (id == R.id.btnChameleon_Sniff_Decrypt_Log) {
            if (mMsgAdapter.getCount() == 0) {
                showToast(getString(R.string.msg_no_history));
            } else {
                mMsgDialog.show();
            }
        } else if (id == R.id.btnChameleon_Slot_Aliases) {
